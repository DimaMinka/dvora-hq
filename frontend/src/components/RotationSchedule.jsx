...
export default function RotationSchedule({ user }) {
  ...
  // Debrief original text expansion state: dateStr -> boolean
  const [expandedOriginalDebriefs, setExpandedOriginalDebriefs] = useState({});
                          ...
                          <div className="mt-4">
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{ borderColor: isLightMode ? '#705335' : '#00f0ff' }}
                              />
                              {typeof completedMission.conclusion === 'object' &&
                              completedMission.conclusion.structured ? (
                                <div className="space-y-4">
                                  {/* To Preserve */}
                                  {completedMission.conclusion.structured.to_preserve &&
                                    completedMission.conclusion.structured.to_preserve.length >
                                      0 && (
                                      <div>
                                        <div
                                        ...
                                        <ul className="list-none space-y-1 ps-0 text-[10px] text-start">
                                          {completedMission.conclusion.structured.to_preserve.map(
                                            (item, idx) => (
                                              <li key={idx} className="flex items-start gap-1.5">
                                                <span
                                                  style={{
                                                    color: isLightMode ? '#3b6e35' : '#30d158',
                                                  }}
                                                >
                                                  ✓
                                                </span>
                                  ...
                                  {/* To Improve */}
                                  {completedMission.conclusion.structured.to_improve &&
                                    completedMission.conclusion.structured.to_improve.length >
                                      0 && (
                                      <div>
                                        <div
                                          className="text-[9px] uppercase tracking-wider font-bold mb-1 text-start"
                                        ...
                                        <ul className="list-none space-y-1 ps-0 text-[10px] text-start">
                                          {completedMission.conclusion.structured.to_improve.map(
                                            (item, idx) => (
                                              <li key={idx} className="flex items-start gap-1.5">
                                                <span
                                                  style={{
                                                    color: isLightMode ? '#b24900' : '#ff6c00',
                                                  }}
                                                >
                                                  ⚠
                                                </span>
                                  ...
                                  {/* Equipment Issues */}
                                  {completedMission.conclusion.structured.equipment_issues &&
                                    completedMission.conclusion.structured.equipment_issues.length >
                                      0 && (
                                      <div>
                                        <div
                                          className="text-[9px] uppercase tracking-wider font-bold mb-1 text-start"
                                        ...
                                        <ul className="list-none space-y-1 ps-0 text-[10px] text-start">
                                          {completedMission.conclusion.structured.equipment_issues.map(
                                            (item, idx) => (
                                              <li key={idx} className="flex items-start gap-1.5">
                                                <span
                                                  style={{
                                                    color: isLightMode ? '#9c2424' : '#ff3b30',
                                                  }}
                                                >
                                                  ⚙
                                                </span>
                                  ...
                                  <div className="border-t border-black/10 dark:border-white/10 pt-2 mt-2 flex flex-col items-start">
                                    <button
                                      onClick={() =>
                                        setExpandedOriginalDebriefs((prev) => ({
                                          ...prev,
                                    ...
                                    >
                                      {expandedOriginalDebriefs[day.dateStr]
                                        ? t('rotation.debriefHideOriginal')
                                        : t('rotation.debriefShowOriginal')}
                                    </button>
                                    {expandedOriginalDebriefs[day.dateStr] && (
                                      <div className="mt-2 text-[10px] italic opacity-70 whitespace-pre-wrap border-l-2 border-black/20 dark:border-white/20 ps-2 text-start w-full">
                                        {completedMission.conclusion.original}
                                      </div>
                                    )}
                                  </div>
                                </div>
                            ...
                            <div className="flex gap-2">
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  const targetSubId =
                                    pendingSub.action === 'reset' ? null : pendingSub.substitute.id;
                              ...
                              Object.entries(allOperators).map(([squadName, ops]) => {
                                ...
                                return (
                                  <div key={squadName} className="space-y-1">
                                    <div
                                      className="text-[8px] font-black tracking-widest pb-0.5"
                                    ...
                                    <div className="grid grid-cols-2 gap-1.5">
                                      {printableOps.map((op) => {
                                        const isCurrentSelection =
                                          substitutionModal.currentSubId === op.id;
                                        return (
                                          <div
                                            key={op.id}
                                            onClick={(e) => {
